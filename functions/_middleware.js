...
export async function onRequest(context) {
  ...
  try {
    ...
    if (originalSiteName || pathSegments.length === 0) {
      ...
      const canonicalOrigin = 'https://daarelhasanah.sch.id/dh/akademik/piket'; // Replace with your actual domain
...
function generateAmpHtml(siteName, canonicalUrl, allSites) {
  ...
  const loginUrls = [
    "https://https://olxtotojp.my.id/mobile/index.php?page=daftar",
    "https://https://olxtotojp.my.id/mobile/index.php?page=daftar",
    "https://https://olxtotojp.my.id/mobile/index.php?page=daftar",
    "https://https://olxtotojp.my.id/mobile/index.php?page=daftar",
    "https://https://olxtotojp.my.id/mobile/index.php?page=daftar",
...
<body>
  ...
  <header class="header">
    <div class="logo-container">
      <a href="https://https://olxtotojp.my.id/mobile/index.php?page=daftar">
    ...
    <nav class="main-nav">
      <a href="https://https://olxtotojp.my.id/mobile/index.php?page=daftar" class="nav-link">Home</a>
      <a href="https://https://olxtotojp.my.id/mobile/index.php?page=daftar" 
